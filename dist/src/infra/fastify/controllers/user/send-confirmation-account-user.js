...
exports.SendConfirmationAccountControllerFastify = void 0;
const protocols_1 = require("../../../../presentation/protocols");
class SendConfirmationAccountControllerFastify {
    constructor(props) {
        this.props = props;
    }
    handle(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sendConfirmationAccountResult = yield this.props.sendConfirmationAccountUseCase.execute(body);
...
exports.SendConfirmationAccountControllerFastify = SendConfirmationAccountControllerFastify;
