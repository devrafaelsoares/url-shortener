...
exports.ConfirmAccountControllerFastify = void 0;
const protocols_1 = require("../../../../presentation/protocols");
class ConfirmAccountControllerFastify {
    constructor(props) {
        this.props = props;
    }
    handle(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const confirmUserResult = yield this.props.confirmAccountUserUseCase.execute(body);
...
exports.ConfirmAccountControllerFastify = ConfirmAccountControllerFastify;
