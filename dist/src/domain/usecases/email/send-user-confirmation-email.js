...
exports.SendUserConfirmationEmailUseCase = void 0;
...
class SendUserConfirmationEmailUseCase {
    constructor(props) {
        this.props = props;
    ...
    send(user) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const htmlContent = email_1.userEmailConfirmationApiTemplateHtml
                .replace("[ID_ACCOUNT_CONFIRMATION]", id)
                .replace("[TOKEN_ACCOUNT_CONFIRMATION]", verificationTokens
...
exports.SendUserConfirmationEmailUseCase = SendUserConfirmationEmailUseCase;
